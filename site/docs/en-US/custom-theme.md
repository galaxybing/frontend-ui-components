...
If you just want to change the theme color of Element, the theme preview website is recommended.
...
# from GitHub
npm i http://gitlab.317hu.com/dev-web/frontend-ui-components/theme-default -D
```
